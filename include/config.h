...
#define         ENABLE_SYNC_OBJECT_TRACKING     0       // Must also have console window enabled to work [DEBUG build only]
#define         ENABLE_OBJECT_TRACKING          0       // Dbg message thread data classes constructors/destructors & Cslot & threads
