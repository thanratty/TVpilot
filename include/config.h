...
#define         ENABLE_CRT_DUMP                 1       // Enables CRT memory leak check dump
...
#define         ENABLE_OBJECT_TRACKING          1       // Dbg message thread data classes constructors/destructors & Cslot & threads
